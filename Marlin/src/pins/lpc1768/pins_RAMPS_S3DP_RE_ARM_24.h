...
//#define RAMPS_D8_PIN       P2_07   // D8 to drive the SSR
//
// Servos
//
...
#ifndef X_CS_PIN
  #define X_CS_PIN         P0_26   // A9 wired ok D63
#endif
...
#ifndef Y_CS_PIN
  #define Y_CS_PIN         P1_04   // ETH wired to ramps1.6+ pin D40
#endif
...
#ifndef Z_CS_PIN
  #define Z_CS_PIN         P1_10   // ETH wired to ramps1.6+ pin D42
#endif
...
#ifndef E0_CS_PIN
  #define E0_CS_PIN        P1_01   // ETH wired to ramps1.6+ pin A11/D65
#endif
...
#ifndef E1_CS_PIN
  #define E1_CS_PIN        P1_14   // ETH wired to ramps1.6+ pin A12/D66
#endif
...
//
#define TEMP_0_PIN          3   // A3 - (63) Analog Input PT100 - J5-3 & AUX-2
#define TEMP_BED_PIN        1   // A1 (T1) - (68) - TEMP_BED_PIN - (A14) Analog Input
#define TEMP_1_PIN          4   // A4 - (37) Analog Input PT100 - BUZZER_PIN
#define TEMP_2_PIN          0   // A0 (T0) - (67) - TEMP_0_PIN
#define TEMP_3_PIN          2   // A2 (T2) - (69) - TEMP_1_PIN
...
// Fans
// cooling parts fans
#define FAN_PIN            P1_21   // (4) IO pin. Buffer needed

/* Fan Expansion board pins
* * Hotends Fans
**use same pin
**********************************/
#define E0_AUTO_FAN_PIN     -1 //(11)   SERVO0_PIN IO pin. Buffer needed - D6 Servo pin 6 for Hotend Fan0
#define E1_AUTO_FAN_PIN     -1 //(11)   SERVO0_PIN       J5-1  // (4) IO pin. Buffer needed - D5 Servo pin 5 for Hotend Fan1
#undef CHAMBER_AUTO_FAN_PIN
#define CHAMBER_AUTO_FAN_PIN    P1_20 //(11)   SERVO0_PIN
#define CONTROLLER_FAN_PIN  P1_20 //(11)   SERVO0_PIN 
//
// Misc. Functions
//
