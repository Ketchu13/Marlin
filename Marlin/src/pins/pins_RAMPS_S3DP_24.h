...
#define BOARD_NAME "Re-ARM RAMPS 1.6P"
...
#else
  #define TEMP_0_PIN          5   // A5 - (49) - SD_DETECT_PIN 1.31
#endif
//#define TEMP_0_PIN          5   // A5 - (49) - SD_DETECT_PIN1.31
#define TEMP_BED_PIN        1   // A1 (T1) - (68) - TEMP_BED_PIN
#define TEMP_1_PIN          4   // A4 - (37) - BUZZER_PIN1.30
...
#define FAN_PIN             P1_21 // (6) IO pin. Buffer needed
#define FAN1_PIN            P1_18 // (4) IO pin. Buffer needed
#define E0_AUTO_FAN_PIN     P1_19 // (5) IO pin. Buffer needed
#define E1_AUTO_FAN_PIN     P2_06 // (D59)
 ...
 */
  ...
  #else
    #define BEEPER_PIN     P1_23   // lcd plug rewired
