...
#define MSG_PREHEAT_3                       _UxGT("Préchauffage " PREHEAT_2_LABEL)
#define MSG_PREHEAT_3_N                     _UxGT("Préchauff. " PREHEAT_2_LABEL " ")
#define MSG_PREHEAT_3_ALL                   _UxGT("Préch. " PREHEAT_2_LABEL " Tout")
#define MSG_PREHEAT_3_END                   _UxGT("Préch. " PREHEAT_2_LABEL " buse")
#define MSG_PREHEAT_3_BEDONLY               _UxGT("Préch. " PREHEAT_2_LABEL " lit")
#define MSG_PREHEAT_3_SETTINGS              _UxGT("Régl. préch. " PREHEAT_2_LABEL)
...
#define MSG_MOVE_001MM                      _UxGT("Déplacer. 0.01mm")
