...
#define STRING_CONFIG_H_AUTHOR "(Ketchu13, CR-10 S5)" // Who made the changes.
...
#define DEBUG_LEVELING_FEATURE
  ...
  #define RIGHT_PROBE_BED_POSITION ( min ( X_BED_SIZE - MIN_PROBE_EDGE , X_BED_SIZE + X_PROBE_OFFSET_FROM_EXTRUDER))//(X_BED_SIZE - (MIN_PROBE_EDGE))
